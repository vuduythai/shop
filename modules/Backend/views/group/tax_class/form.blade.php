...
<input type="hidden" id="item-factory-model-name" value="tax_rate" />
...
<div class="col-md-12 row-item-form">
    ...
    <div id="btn-items">
        <div class="btn btn-default item-action" id="create-item">
            ...
            {{ __('Backend.Lang::lang.tax_class.create_'.$form['itemName']) }}
        </div>
        <div class="btn btn-default item-action" id="attach-item">
            <i class="fa fa-plus" aria-hidden="true"></i>
            {{ __('Backend.Lang::lang.tax_class.attach_'.$form['itemName']) }}
        </div>
